<?php
// $firstname = 'Suraj';
// echo $generateduserID = sha1(mt_rand(10,99).$firstname);
...
//     // of specified length
//     return $firstname.$lastname.substr(str_shuffle($str_result), 0, $length_of_string);
// }
...
// echo ywt_get_first_char($name); //print H
